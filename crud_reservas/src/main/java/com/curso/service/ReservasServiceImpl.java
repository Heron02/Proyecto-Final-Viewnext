...
public class ReservasServiceImpl implements ReservasService {
    ...
    private String url2 = "http://localhost:7000/";
     ...
     * @return reservasInfoList
     */
    public static List<ReservaInfo> convertirAReservaInfo(List<Reserva> reservas) {
        List<ReservaInfo> reservasInfoList = new ArrayList<>();

        for (Reserva reserva : reservas) {
            ReservaInfo reservaInfo = convertirReservaAReservaInfo(reserva);
     ...
     * @return reservasInfoList
     */
    public static ReservaInfo convertirReservaAReservaInfo(Reserva reserva) {
        ...
        return new ReservaInfo((int) reservaMap.get("idvuelo"), (String) reservaMap.get("dni"),
